...
cover:
    image: "img/blogs/78-networking-basic.png"
...
{{< figure
    src="/img/blogs/78-network-type.jfif"
...
{{< figure
    src="/img/blogs/78-network-topology.png"
...
{{< figure
    src="/img/blogs/78-data-communication.webp"
...
{{< figure
    src="/img/blogs/78-network-devices.png"
...
{{< figure
    src="/img/blogs/78-transmission-media.png"
...
{{< figure
    src="/img/blogs/78-data-communication-model.png"
