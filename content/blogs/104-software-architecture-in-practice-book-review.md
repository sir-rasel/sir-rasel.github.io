...
cover:
    image: "img/blogs/104-software-architecture-practice-book.jfif"
    caption: "Software Architecture in Practice Book"
    alt: "Software Architecture in Practice Book"
    relative: true
    hidden: true
---
...
{{< figure
    src="/img/blogs/104-software-architecture-practice-book.jfif"
    caption="Software Architecture in Practice Book (Photo Credit: Google)"
    align=center
>}}
